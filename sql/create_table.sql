...
(
    ...
    user_avatar_bucket varchar(1024)                          null comment 'minio对应桶',
    user_avatar_object varchar(1024)                          null comment 'minio对象名称',
...
(
    ...
    object       varchar(1024)                      not null comment 'minio对像名称',
    bucket       varchar(1024)                      null comment 'minio桶名',
